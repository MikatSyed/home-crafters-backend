...
const paymentVerify = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.PaymentService.paymentVerify(
      transactionId
    );
    console.log(
      result === null || result === void 0 ? void 0 : result.transactionId,
      'aaaaa'
    );
    ...
    if (result && result.count > 0) {
      ...
      res.redirect(
        `https://home-crafter-mikatsyed.vercel.app/success?transactionId=${
          result === null || result === void 0 ? void 0 : result.transactionId
        }`
      );
    } else {
...
const getAllFromDB = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const filters = (0, pick_1.default)(
        req.query,
        payment_constants_1.paymentFilterableFields
      );
      ...
      const result = yield payment_service_1.PaymentService.getAllFromDB(
        filters,
        options
      );
      (0, sendResponse_1.default)(res, {
...
const deleteFromDB = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
