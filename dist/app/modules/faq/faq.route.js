...
router.post(
  ...
  (0, validateRequest_1.default)(
    faq_validation_1.FaqValidation.createFaqZodSchema
  ),
...
router.patch(
  '/:id',
  (0, validateRequest_1.default)(
    faq_validation_1.FaqValidation.updateFaqZodSchema
  ),
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
  faq_controller_1.FaqController.updateOneInDB
);
router.delete(
  '/:id',
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
  faq_controller_1.FaqController.deleteByIdFromDB
);
