...
const fetchBookingsForDate = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookingDate = req.query.bookingDate;
    // console.log('c',bookingDate)
    const result = yield booking_service_1.BookingService.fetchBookingsForDate(
      bookingDate
    );
    (0, sendResponse_1.default)(res, {
      statusCode: 200,
...
const getStatistics = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
