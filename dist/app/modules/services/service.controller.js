...
const insertIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield service_service_1.ServiceServices.insertIntoDB(
      req.body
    );
...
const getAllFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const queryOptions = (0, pick_1.default)(
      req.query,
      service_constant_1.queryFields
    );
    console.log(queryOptions);
    const result = yield service_service_1.ServiceServices.getAllFromDB(
      filters,
      queryOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateOneInDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield service_service_1.ServiceServices.updateOneInDB(
      id,
      req.body
    );
    (0, sendResponse_1.default)(res, {
